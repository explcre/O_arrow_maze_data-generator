...
The dot stops at row {end_row+1}, column {end_col+1} (arrow points {exit_direction}, outside boundary the ball enters a cycle (a looped path), e.g., the left cell points right and the right cell points left.).
...
def get_all_prompts() -> list[str]:
    return [
        "Blue dot follows arrows, yellow visited cells, stops at boundary or the ball enters a cycle (a looped path), e.g., the left cell points right and the right cell points left. green border on final square."
    ]
